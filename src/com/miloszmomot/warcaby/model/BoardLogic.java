...
import static com.miloszmomot.warcaby.MoveType.INVALID;
import static com.miloszmomot.warcaby.MoveType.KILL;
...
public class BoardLogic {
                    ...
                    for (int j = -1; j <= 1; j += 2) {
                        ...
                        for (int k = 2; k < boardSize; k++) {
                            ...
                            if (y + k * i >= 0 && y + k * i < boardSize && x + k * j >= 0 && x + k * j < boardSize) {
                                ...
                                if (pikw > 1) {
                                    //if more than one we stop checking this direction
                                    break;
                                }
                            }
                        }
    ...
    private PieceColor winCheck() {
        ...
        if (lightCounter==0) return PieceColor.LIGHT;
        if (darkCounter==0) return PieceColor.DARK;
        return null;
    }
